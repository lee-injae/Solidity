...
contract NotAvgJoe_Test_Jan09_v02 is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxFreeMintSupply = 33;                     // Update later
  
  // Input: Key variables - whitelist sale
  uint256 public whitelistSalePrice = 0.05 ether;
  uint256 public maxWhitelistSupply = 300;                   // Update later
  uint256 public maxWhitelistSaleMintAmount = 3;             // Update later
  uint256 public nftPerAddressLimit = 3;                     // Update later
  ...
  uint256 public maxSupply = 3333;                          // Update later
  uint256 public maxPublicSaleMintAmount = 3;               // Update later
